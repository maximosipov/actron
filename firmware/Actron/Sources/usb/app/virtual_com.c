...
/* Receive Buffer */
uint_8 g_curr_recv_buf[DATA_BUFF_SIZE];
/* Send Buffer */
uint_8 g_curr_send_buf[DATA_BUFF_SIZE];
/* Receive Data Size */
uint_8 g_recv_size;
/* Send Data Size */
uint_8 g_send_size;
